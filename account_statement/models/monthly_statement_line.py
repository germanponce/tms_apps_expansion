...
class monthly_statement_line(models.Model):
	...
	amount_total_signed = fields.Monetary(related='invoice_id.amount_total', currency_field='currency_id',)
	amount_residual = fields.Monetary(related='invoice_id.residual')
	amount_residual_signed = fields.Monetary(related='invoice_id.residual', currency_field='currency_id',)
