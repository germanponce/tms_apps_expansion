    ...
    def _get_untaxed_amount_in_company_currency(self):
        for invoice in self:
            ...
            if invoice.currency_id.id != invoice.company_id.currency_id.id:
                ...
                amount = currency_id._convert(invoice.amount_untaxed, invoice.company_id.currency_id, invoice.company_id, invoice.date_invoice or fields.Date.today())

            invoice.amount_untaxed_company_currency = amount
