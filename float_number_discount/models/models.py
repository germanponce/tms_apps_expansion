...
class Sale_order_line_inherit(models.Model):
    ...
    discount_amount = fields.Float(string=_('Descuento $'), default=0.0, digits=(10,2))
    discount = fields.Float(string=_('Descuento (%)'), digits=(2,6), default=0.0)
    discount_show = fields.Float(string=_('Descuento (%)'), digits=(2,2), default=0.0)
...
class Sale_order_inherit(models.Model):
    ...
    discount = fields.Monetary(string=_('Descuento'), default=0.0, store=True, readonly=True,
                               compute='_compute_discount', currency_field='currency_id')
    amount_without_discount_tax = fields.Monetary(string=_('Monto sin Descuento/Impuestos'), default=0.0, store=True,
